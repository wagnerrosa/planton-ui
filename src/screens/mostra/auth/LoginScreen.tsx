...
export function MostraLoginScreen() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface-default p-6">
      <div className="w-full max-w-sm border border-border p-10 flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          <Eyebrow>Planton + Nude</Eyebrow>
          <Heading as="h1" size="heading-lg">Mostra Sua Pegada</Heading>
          <Body size="sm" muted>
            Plataforma de admin para gestão de participantes
          </Body>
        </div>
