...
export function TutorPanel({
  ...
  return (
    <div
      className={cn(
        'fixed bottom-24 right-6 z-[60] flex h-[min(580px,calc(100dvh-8rem))] w-[380px] flex-col overflow-hidden',
        ...
        'max-md:inset-x-4 max-md:bottom-24 max-md:right-auto max-md:w-auto',
        open
